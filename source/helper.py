SCRAPER_CONFIG = {
    "praxis": {
        ...
        "product_name": {
            "type": "soup",
            "find": {"name": "h1", "class_": "chakra-heading mxd-product-detail-layout-heading pdfi-kbivdx"}
        },
        "price": {
            "type": "json-ld",
    ...
    "karwei": {
        ...
        "product_name": {
            "type": "soup",
            "find": {"name": "h1", "itemprop": "name"}
        },
        "price": {
            "type": "soup",
            "find": {"name": "div", "class_": "star-ratings-css"}
        },
        "proxy": {"http": "http://proxy.jpmchase.net:8443", "https": "http://proxy.jpmchase.net:8443"}
    },
    "wickes": {
        ...
        "api": {
            ...
            "price_path": ["ProductsDetail", 0, "SpecialPrice"],  # fallback to "Price" if None
        },
        "proxy": {"http": "http://proxy.jpmchase.net:8443", "https": "http://proxy.jpmchase.net:8443"}
    },
    ...
    "diy": {
        ...
        "proxy": {"http": "http://approxy.jpmchase.net:10443", "https": "http://approxy.jpmchase.net:10443"}
    },
    ...
    "castorama": {
        ...
        "product_name": {
            "type": "soup",
            "find": {"name": "h1", "id": "product-title"}
        },
        "price": {
            "type": "soup",
            "find": {"name": "div", "class_": "_5d34bd7a"}
        },
        "proxy": {"http": "http://approxy.jpmchase.net:10443", "https": "http://approxy.jpmchase.net:10443"}
    },
    ...
    "bricodepot": {
        ...
        "product_name": {
            "type": "soup",
            "find": {"name": "h1", "class_": "bd-ProductCard-title"}
        },
        "price": {
            "type": "soup",
            "find": {"name": "span", "class_": "bd-Price-current"},
            "currency_meta": {"itemprop": "priceCurrency"}
        },
        "proxy": {"http": "http://approxy.jpmchase.net:10443", "https": "http://approxy.jpmchase.net:10443"}
    }
}